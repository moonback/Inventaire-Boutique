...
- [x] **Barre de Recherche** : Permettre de filtrer la grille d'inventaire textuellement par nom de produit ou marque.
- [x] **Filtres Avancés** : Filtrer et grouper visuellement les produits par catégorie ou par quantité.
