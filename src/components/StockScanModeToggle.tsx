...
export function StockScanModeToggle({
  ...
  return (
    <div className="mb-5 rounded-2xl border border-stone-200 bg-stone-50 p-3.5">
      <div className="flex items-center justify-between gap-3">
        ...
        <button
          ...
          className={`relative inline-flex h-7 w-12 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out outline-none ${
      ...
      <div className="mt-3 grid grid-cols-2 gap-1 rounded-xl border border-stone-200 bg-white p-1">
        <button
          ...
          disabled={!enabled}
          className={`flex items-center justify-center gap-1.5 rounded-lg py-2 text-[11px] font-bold transition disabled:opacity-50 ${
            mode === "add"
